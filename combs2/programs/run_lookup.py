...
def main():
    ...
    combs2.validation.lookup.run_lookup(_path_to_pdb, _path_to_database, _outdir,
                                        filename=filename, skipping_number=skipping_number, distance_cutoff=distcut,
                                        probe_segname1=probe_segname1, probe_chain1=probe_chain1, probe_resnum1=probe_resnum1,
                                        probe_segname2=probe_segname2, probe_chain2=probe_chain2, probe_resnum2=probe_resnum2,
                                        probe_sel_criteria=sel_criteria, maxbonded=max_bonded, explicit_H=explicit_H,
